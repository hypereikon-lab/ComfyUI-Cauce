...
- [Node catalog](NODE_CATALOG.md): all 24 registered nodes and their sockets.
...
- [Motion maps](MOTION_MAPS.md): inverse pullbacks, composition, advection,
...
- [Technical language](TECHNICAL_LANGUAGE.md): canonical operation names and
  evidence states.

## Runtime

- [Remote ComfyUI runtime](REMOTE_COMFY_RUNTIME.md): Cloudflare boundary,
  Manager, HTTP/WebSocket surfaces, browser workflow state, deployment, and
  recovery. This document is package-neutral.
